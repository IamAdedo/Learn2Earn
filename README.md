...
Learn2Earn.ng is a zero-tuition tech talent accelerator operating physical [campuses across Nigeria](https://github.com/IamAdedo/Learn2Earn/blob/main/campuses.md). The program leverages the **01Edu platform and pedagogy**—honed over 25 years by pioneers like __Nicolas Sadirac__, to completely eliminate traditional lecture structures, teachers, and classrooms.
...
* **Hyper-Inflation of Tuition:** Traditional higher education and premium tech bootcamps cost thousands of nairas, completely gating out brilliant minds from low-to-middle income backgrounds.
...
* Those unable to cope with constructive critique, constant peer evaluation, constructive peer criticism, ambiguous instructions, open-ended assignments, or intense collaborative problem-solving.

* Individuals looking for traditional, passive classroom systems where an instructor explicitly feeds them every line of code, traditional classroom instruction, passive lectures, or step-by-step code dictation.
...
**Phase 1: Logic Test** \
*(90-Min Gamified App)* \
[Play the free online game](https://auth.learn2earn.ng/register). It tests memory, and problem-solving; not prior knowledge. Do well, and you're invited to the Trials. \
...
* **Format:** A grueling, fast-paced immersion designed as both a training camp and an audition. A trial-by-fire scenario where candidates dive into daily coding projects with zero lectures. Candidates face tight daily deadlines and massive project loads with no initial instructions to filter for psychological endurance, adaptability, and teamwork. Candidates must learn to use documentation, lean on peers, and survive tight daily deadlines.
